 ...
 * @Date: 7/23/2018
 * Sections marked with //TODO and any subsequent helper functions are completed by Author
 * 
 * 
...
public class MyIntSET {
	...
	private Node removeSingles(Node temp) {
		...
		if(temp != null) {
			...
			if(temp.left != null && temp.left.right != null && temp.left.left == null)
	...
	private static void testMutators () {
		...
		testRemoveSingles ("41 11 61", "41 21 61 11");
		testRemoveSingles ("40", "50 40");
		testRemoveSingles ("30 20 61 50 64", "30 20 81 61 50 64");
	}
